...
class Rocket(tile: RocketTile)(implicit p: Parameters) extends CoreModule()(p)
  ...
  microEvents.addEvent("I$ blocked", () => icache_blocked, 3)
  microEvents.addEvent("D$ blocked", () => id_ctrl.mem && dcache_blocked, 4)
  ...
  sysEvents.addEvent("D$ miss", () => io.dmem.perf.acquire, 1)
  sysEvents.addEvent("D$ release", () => io.dmem.perf.release, 2)
  ...
  //hook up the core to the outside world
